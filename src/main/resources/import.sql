...
-- Insert a product
INSERT INTO products (description, product_code, weight, price, length, category_id) VALUES ('Perfil C 2x2x0.85 40x38x8x0.85 6000MM', '2000-06000', 0.83, 1500.0, 6, 1);
INSERT INTO products (description, product_code, weight, price, length, category_id) VALUES ('Perfil C 2x2x0.85 40x38x8x0.85 2400MM', '2000-02400', 0.83, 1000.0, 2.4, 1);
INSERT INTO products (description, product_code, weight, price, length, category_id) VALUES ('Perfil C 2x2x0.85 40x38x8x0.85 3000MM', '2000-03000', 0.83, 1200.0, 3, 1);
